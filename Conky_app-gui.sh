...
Cmnd_Alias CONKY_NETWORK = /usr/bin/netstat, /usr/bin/hostname
Cmnd_Alias CONKY_LOGS = /usr/bin/journalctl, /usr/bin/grep, /usr/bin/cat
Cmnd_Alias CONKY_RKHUNTER = /usr/bin/rkhunter --update, /usr/bin/rkhunter --propupd, /usr/bin/rkhunter --check --sk
Cmnd_Alias CONKY_SYSTEM = /usr/bin/lsof, /usr/bin/curl
...
%usergroup ALL=(ALL) NOPASSWD: CONKY_SENSORS, CONKY_NETWORK, CONKY_LOGS, CONKY_SYSTEM
