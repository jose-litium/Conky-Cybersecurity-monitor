...
<img src="https://github.com/jose-litium/Conky-Cybersecurity-monitor/blob/main/1.png" alt="Final version look" style="width:30%; height:auto;" />
...
- RKHunter warnings: `~/.local/conky_app/rkhunter_warnings.txt` (or `/var/log/rkhunter_warnings.log` for system-wide service)
